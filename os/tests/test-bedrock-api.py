...
""", encoding="utf-8")
        ...
        storage.write_text(json.dumps({"schema": 1, "generated_unix": 100, "overall": "healthy", "read_only": True, "disks": [{"path": "/dev/sda", "serial": "private-serial", "model": "Bedrock SSD", "size_bytes": 1000000000, "transport": "sata", "smart": {"available": True, "passed": True, "temperature_c": 31, "power_on_hours": 1000, "power_mode": "ACTIVE", "command_exit": 0, "health": "healthy"}}, {"path": "/dev/sdb", "serial": None, "model": "Archive", "size_bytes": 2000000000, "transport": "sas", "smart": {"available": False, "passed": None, "temperature_c": None, "power_on_hours": None, "power_mode": "unknown", "command_exit": 1, "health": "unknown"}}], "disk_candidates": [{"id": "disk-0123456789abcdef0123", "model": "Bedrock SSD", "size_bytes": 1000000000, "transport": "sata", "health": "healthy", "eligible": False, "reason": "system"}, {"id": "disk-abcdef0123456789abcd", "model": "Archive", "size_bytes": 2000000000, "transport": "sas", "health": "healthy", "eligible": True, "reason": "available"}], "managed_pools": [{"name": "archive", "backend": "mdraid", "layout": "raid6", "state": "exported", "members": []}, {"name": "main", "backend": "zfs", "layout": "mirror", "state": "online", "members": ["disk-0123456789abcdef0123"]}], "software_raid": {"md_arrays": [{"name": "md0", "path": "/dev/md0", "level": "raid1", "state": "active", "member_pattern": "UU", "expected_members": 2, "active_members": 2, "health": "healthy", "sync": {"action": None, "percent": 0}}], "zfs": {"available": True, "pools": [{"name": "main", "size_bytes": 1000, "allocated_bytes": 400, "free_bytes": 600, "health": "ONLINE", "status": "healthy"}]}}, "hardware_raid": {"controllers": [{"address": "0000:01:00.0"}], "management_tools": [], "vendor_reports": [], "explanation": "limited"}}), encoding="utf-8")
