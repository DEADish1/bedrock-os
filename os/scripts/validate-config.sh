...
sh -n "$OS_DIR/tests/test-vm-create.sh"
...
sh -n "$OS_DIR/tests/test-vm-image-import-action.sh"
...
sh -n "$OS_DIR/tests/test-nas-credential-stage.sh"
...
sh -n "$OS_DIR/config/includes.chroot/usr/lib/bedrock/change-vm-image"
sh -n "$OS_DIR/config/includes.chroot/usr/lib/bedrock/create-vm-console-session"
sh -n "$OS_DIR/config/includes.chroot/usr/lib/bedrock/redeem-vm-console-session"
sh -n "$OS_DIR/config/includes.chroot/usr/lib/bedrock/start-vm-console-proxy"
...
sh -n "$OS_DIR/config/includes.chroot/usr/lib/bedrock/change-vm-passthrough"
...
sh -n "$OS_DIR/config/includes.chroot/usr/lib/bedrock/configure-remote-relay"
...
sh -n "$OS_DIR/scripts/create-spdx-sbom.sh"
...
grep -q '^RestrictAddressFamilies=AF_UNIX AF_INET$' "$OS_DIR/config/includes.chroot/usr/lib/systemd/system/bedrock-api.service"
grep -q '^ProtectSystem=strict$' "$OS_DIR/config/includes.chroot/usr/lib/systemd/system/bedrock-api.service"
grep -q '^StateDirectory=bedrock/virtualization/uploads$' "$OS_DIR/config/includes.chroot/usr/lib/systemd/system/bedrock-api.service"
...
sh "$OS_DIR/tests/test-spdx-sbom.sh"
...
sh "$OS_DIR/tests/test-vm-create.sh"
...
sh -n "$OS_DIR/tests/validate-vm-guest-acceptance.sh"
sh "$OS_DIR/tests/test-vm-guest-acceptance.sh"
...
sh "$OS_DIR/tests/test-vm-passthrough-change.sh"
...
sh "$OS_DIR/tests/test-relay-config.sh"
...
python3 "$OS_DIR/tests/test-diagnostic-bundle.py"
python3 "$OS_DIR/tests/test-config-backup.py"
python3 "$OS_DIR/tests/test-backup.py"
sh "$OS_DIR/tests/test-backup-change.sh"
python3 "$OS_DIR/tests/test-notifications.py"
python3 "$OS_DIR/tests/test-maintenance-ups.py"
python3 "$OS_DIR/tests/test-apps.py"
sh "$OS_DIR/tests/test-app-change.sh"
...
sh "$OS_DIR/tests/test-storage-change.sh"
sh "$OS_DIR/tests/test-nas-management.sh"
sh "$OS_DIR/tests/test-nas-credential-stage.sh"
sh "$OS_DIR/tests/test-nas-identity-change.sh"
