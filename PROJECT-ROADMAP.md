...
- [ ] Finish Storage, VMs, Images, Apps, Connect, Backup, Hardware, Settings, and Help.
  ...
  - Virtual machines now have a dedicated authenticated v1 inventory contract for lifecycle state, autostart, allocations, snapshots, and logical attachments. Host paths, console sockets, MAC addresses, raw definitions, and passthrough topology remain outside the response; live interface replacement and mutations remain.
