...
- [ ] Finish Storage, VMs, Images, Apps, Connect, Backup, Hardware, Settings, and Help.
  ...
  - Users now has a dedicated authenticated read contract for managed NAS accounts, credential-rotation state, and group membership counts. Passwords, hashes, member identities, datasets, ACLs, share paths, and snapshots remain outside the response; the live interface and authenticated mutations remain.
