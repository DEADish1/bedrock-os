...
- [ ] Finish Storage, VMs, Images, Apps, Connect, Backup, Hardware, Settings, and Help.
  ...
  - Hardware now has a dedicated authenticated v1 read contract that exposes useful capability and health context while stripping device paths, interface and bus identities, MAC addresses, serials, and passthrough topology. Interface integration remains.
