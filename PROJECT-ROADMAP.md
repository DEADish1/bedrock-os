...
- [ ] Finish Storage, VMs, Images, Apps, Connect, Backup, Hardware, Settings, and Help.
  ...
  - The image library now publishes a root-generated path-free inventory after initialization, import, and conversion, with an authenticated v1 contract for format, size, SHA-256, and conversion provenance. Live interface replacement and mutations remain.
