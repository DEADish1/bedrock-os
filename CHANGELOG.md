...
- Added a guarded passthrough-change orchestrator that requires separate review and mutation confirmations, binds authorization to the generated plan hash, revalidates hardware at execution, and removes transient authorization material.
