...
- Added strong ETag/If-Match concurrency protection to update-policy changes, remote trust, application lifecycle, backup creation/run/restore actions, and all virtual-machine changes, including explicit missing/stale precondition responses and browser refresh behavior.
