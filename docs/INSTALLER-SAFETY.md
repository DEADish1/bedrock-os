...
The helper still stops after preflight with its dedicated non-success exit code. It does not open a physical target until whole-device opening, exclusive access, flush/eject, and real-device acceptance tests are complete.
