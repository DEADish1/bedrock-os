...
Malformed, oversized, indirect, or unavailable task, alert, audit, and remote-device sources fail independently with `503`; the API never returns partially validated records.
